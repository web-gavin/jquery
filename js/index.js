(function ($) {
    $.learuntab = {
        ...
        addTab: function () {
            $(".navbar-menu>ul>li.open").removeClass("open");
            ...
            if (flag) {
                ...
                $('.mainContent').find('.LRADMS_iframe').hide();
                $('.mainContent').append(str1);
                //$.loading(true);
                //既然用了iframe 为什么还要用ajax 这不脑残么
                // $.ajax({
                //     url: dataUrl,
                //     global: false,
                //     type: "GET",
    ...
    $.learunindex = {
        load: function () {
            $("body").removeClass("page-loding")
            $("#container").find('.mainContent').height($(window).height() - 130);
        ...
        dropDown: function () {
            $(".dropdown-btn").click(function (e) {
                $(".dropdown-menu").hide();
                var a = $(this), b = a.next() , c = a.parent();
                if(b.is(":hidden")){
                    b.show();
                }else{
                    b.hide();
            ...
            $(".dropdown-menu").parent().on("click", function(e){
                e.stopPropagation();
            });
